...
class BotTyska(Bot):
    def __init__(self,nome):
        comandos = {"O que você acha mais importante na faculdade?" : "Para mim o importante é ter uma metodologia ativa sempre",
                    "Qual o aspecto de um código orientado a objetos mais importante?" : "Um bom código é um código bem abstrato com pouca rigidez."}
